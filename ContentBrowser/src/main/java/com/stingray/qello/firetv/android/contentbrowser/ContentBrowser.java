...
import com.stingray.qello.firetv.android.search.ISearchAlgo;
...
public class ContentBrowser implements IContentBrowser, ICancellableLoad {
    ...
    private void restoreActivityState(String screenName) {
        ...
        String lastActivity = Preferences.getString(com.stingray.qello.firetv.android.ui.constants
...
//                break;
    ...
    private boolean shouldRestoreLastActivity(Activity activity) {
        ...
        if (activity != null && activity.getIntent() != null &&
            ...
            long lastTimeMs = Preferences.getLong(com.stingray.qello.firetv.android.ui.constants
