...
import com.stingray.qello.firetv.android.adapters.testResources.DummyActionWidgetContainer;
...
public class ActionWidgetAdapterTest {
    ...
    /**
     * Tests the removal of an action from an empty {@link com.stingray.qello.firetv.android.adapters
    ...
    /**
     * Tests the removal of a non-existent action from an {@link com.stingray.qello.firetv.android.adapters
     * .ActionWidgetAdapter}. Expecting a {@link NoSuchElementException}.
     */
