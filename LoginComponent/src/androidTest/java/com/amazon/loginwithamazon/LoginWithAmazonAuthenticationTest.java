...
import com.stingray.qello.android.firetv.login.LoginWithULAuthentication;
...
public class LoginWithAmazonAuthenticationTest {
    ...
    private LoginWithULAuthentication mLoginWithAmazonAuthentication;

    @Before
    public void setUp() throws Exception {

        mLoginWithAmazonAuthentication = new LoginWithULAuthentication();
    ...
    public void testGetAuthenticationActivityIntent() throws Exception {
        ...
        assertTrue("We should get back a LoginInWithAmazonActivity",
                   tempIntent.getComponent()
                             .getClassName()
                             .equals("com.stingray.qello.android.firetv.login.LoginActivity"));
    ...
    /**
     * The method {@link LoginWithULAuthentication#isResourceAuthorized(Context, String,
