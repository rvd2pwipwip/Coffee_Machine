 ...
 * {@link com.stingray.qello.firetv.purchase.model.Product.ProductType#BUY} : This product is supposed to be 'buy
 ...
 * forever.
 *
 * {@link com.stingray.qello.firetv.purchase.model.Product.ProductType#RENT} : This product is rented for a
 * specific period of time and is available only on the device from which the rent request was
 * sent.
 *
 * {@link  com.stingray.qello.firetv.purchase.model.Product.ProductType#SUBSCRIBE} : This product is consumed
